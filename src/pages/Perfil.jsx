    ...
    <div className="container mx-auto px-4 py-10">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="pt-20 px-8 pb-8">
          ...
          {/* AVISO DE CARRITO PENDIENTE (Solo si hay items) */}
          {carrito.length > 0 && (
            <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4 rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="bg-astur-blue text-white p-3 rounded-full">
                  <span className="font-bold text-xl">{carrito.length}</span>
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Finaliza tu compra para asegurar tu plaza.
                  </p>
                </div>
              </div>
              <Link
                to="/carrito"
                className="bg-astur-blue text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700 transition shadow-md whitespace-nowrap"
              >
                Ir al Carrito →
              </Link>
            </div>
          ...
          <div className="mt-10 border-t pt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link
                to="/favoritos"
                className="block p-4 border rounded-lg hover:border-astur-blue hover:bg-blue-50 transition group"
              >
                <span className="text-lg font-bold group-hover:text-astur-blue">
                  ♥ Mis Guapinos
                </span>
                <p className="text-gray-500 text-sm">
                  Gestiona tu lista de deseos ({favorites.length})
                </p>
              </Link>
              <Link
                to="/reservas"
              ...
              >
                ...
                <p className="text-gray-500 text-sm">
                  Consulta tus próximos viajes ({reservas.length})
                </p>
              </Link>
            </div>
          </div>
